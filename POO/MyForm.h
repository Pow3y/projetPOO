...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tabAffichage->Margin = System::Windows::Forms::Padding(4);
			...
			this->tabClient->Margin = System::Windows::Forms::Padding(4);
			this->tabClient->Name = L"tabClient";
			this->tabClient->Padding = System::Windows::Forms::Padding(4);
			...
			this->checkBox1->Location = System::Drawing::Point(391, 257);
			...
			this->tableLayoutPanel15->Margin = System::Windows::Forms::Padding(4);
			...
			this->tableLayoutPanel14->Margin = System::Windows::Forms::Padding(4);
			...
			this->tabCommandes->Margin = System::Windows::Forms::Padding(4);
			this->tabCommandes->Name = L"tabCommandes";
			this->tabCommandes->Padding = System::Windows::Forms::Padding(4);
			...
			this->tabEmployes->Margin = System::Windows::Forms::Padding(4);
			this->tabEmployes->Name = L"tabEmployes";
			this->tabEmployes->Padding = System::Windows::Forms::Padding(4);
			...
			this->tableLayoutPanel12->Margin = System::Windows::Forms::Padding(4);
			...
			this->tabStocks->Margin = System::Windows::Forms::Padding(4);
			this->tabStocks->Name = L"tabStocks";
			this->tabStocks->Padding = System::Windows::Forms::Padding(4);
			...
			this->tableLayoutPanel13->Margin = System::Windows::Forms::Padding(4);
			...
			this->tabStats->Margin = System::Windows::Forms::Padding(4);
			this->tabStats->Name = L"tabStats";
			this->tabStats->Padding = System::Windows::Forms::Padding(4);
			...
			this->StatsButton->Margin = System::Windows::Forms::Padding(4);
			...
			this->StocksButton->Margin = System::Windows::Forms::Padding(4);
			...
			this->EmployesButton->Margin = System::Windows::Forms::Padding(4);
			...
			this->CommandesButton->Margin = System::Windows::Forms::Padding(4);
			...
			this->ClientButton->Margin = System::Windows::Forms::Padding(4);
